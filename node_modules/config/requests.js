...
exports.send = function(no_log, from_id, to_id, msg, time_msg, callback){
...
*/
exports.loadmsg = function(no_log, index, callback){
  var i_var=index+6;
  var que = "SELECT * FROM tmp_log WHERE no_log = " + index + " " +i_var+" ORDER BY id desc limit 6";
