...
/*
exports.EnterRoob = function(from_id, to_id, index, callback) {

var que = "SELECT * from testDB WHERE cli_reg_id =" + from_id + "and par_reg_id="+ to_id +" limit "+index +" "+index+6 +"order by time_message desc" ;
